...
with st.sidebar:
    ...
    embedding_model_name = st.selectbox(
        ...
        [
            ...
            "snowflake/arctic-embed-l",                 # dimension: 1024
            "mixedbread-ai/mxbai-embed-large-v1",       # dimension: 1024
            "nvidia/NV-Embed-v1",                       # dimension: 4096
        ],
    )
    ...
    embeddings = HuggingFaceInferenceAPIEmbeddings(
        api_key=config["HUGGINGFACE_API_KEY"], model_name=embedding_model_name
    )
